        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  href="/products?category=limited-use-industrial-protective-clothing"
                  className="hover:text-white transition-colors"
                >
                  Limited-use Industrial Protective Clothing
                </Link>
              </li>
              <li>
                <Link
                  href="/products?category=chemical-protective-clothing"
                  className="hover:text-white transition-colors"
                >
            ...
            <ul className="space-y-2">
              <li>
                ...
                >
                  ...
                  <span>taco01@gatherwell.top</span>
                </a>
              </li>
              <li>
                <a
